...
git config --global user.email "rezadwi10-bot@users.noreply.github.com"
git config --global user.name "Rezadwi Bot"
git config --global push.default simple

rm -rf deployment
git clone -b master https://github.com/rezadwi10/rezadwi10.github.io deployment
